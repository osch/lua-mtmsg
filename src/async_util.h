...
#define async_util_abort mtmsg_async_util_abort
...
#define async_lock_init mtmsg_async_lock_init
void async_lock_init(Lock* lock);

/* -------------------------------------------------------------------------------------------- */

#define async_lock_destruct mtmsg_async_lock_destruct
...
#define async_mutex_init mtmsg_async_mutex_init
void async_mutex_init(Mutex* mutex);

/* -------------------------------------------------------------------------------------------- */

#define async_mutex_destruct mtmsg_async_mutex_destruct
...
#define async_mutex_wait mtmsg_async_mutex_wait
void async_mutex_wait(Mutex* mutex);

/* -------------------------------------------------------------------------------------------- */

#define async_mutex_wait_millis mtmsg_async_mutex_wait_millis
