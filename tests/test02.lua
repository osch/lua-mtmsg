...
local threadOutBuffer = mtmsg.newbuffer()
...
print("waiting...")
for i = 1, COUNT do
    local j, rslt = threadOutBuffer:nextmsg()
...
while true do
    local r = pack(threadOutBuffer:nextmsg(0))
    print("received", unpack(r, 1, r.n))
    if #r == 0 then 
        break
    end
end
